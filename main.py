        ...
        if planet_id is not None:
            ...
            for offset in offsets:
                ...
                if selected_angle == "ASC":
                    ...
                    for lon in np.arange(-180, 181, 0.5):
                        ...
                        for lat in np.arange(-70, 71, 0.25):
                    ...
                    for row in all_roots:
                        ...
                        for branch in branches:
                            ...
                            for i, lat in enumerate(roots):
                                ...
                                dist = abs(lat - last_lat)

                                if dist < best_dist:
                                    best_dist = dist
                                    best_root = (i, lat)

                            if best_root and best_dist < MAX_LAT_JUMP:
