...
def main() -> int:
    ...
    check("rm-sv3-oa-h-tables" in orbs_fn and "rm-sv3-oa-h-chart" in orbs_fn and "rm-sv3-oa-h-orb" in orbs_fn, "header labels Tables/Chart/Orb")
    ...
    check(".rm-sv3-oa-h-tables { grid-column: 2;" in text, "Tables header column 2")
    check(".rm-sv3-oa-h-chart { grid-column: 3;" in text, "Chart header column 3")
    check(".rm-sv3-oa-h-orb { grid-column: 4;" in text, "Orb header column 4")
