...
def main() -> int:
    ...
    a2a_fn = text.split("function renderComparisonA2aBlockShellHtml", 1)[1][:1200]
    ...
    check("Aspect to Angle" in a2a_fn, "A2A title in bottle")
    check("cmp-angle-pills" in a2a_fn and "cmp-angle-pill" in a2a_fn, "angle pill strip in bottle")
    ...
    check('data-a2a-shape="matrix"' in text, "matrix shape preserved")
