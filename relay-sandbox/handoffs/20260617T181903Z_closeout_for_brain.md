...
## Source: relay-sandbox/results/02_sb-2-write-route-count.md
...
| 3321 | POST | `/comparison-sets/create` |
| 3346 | POST | `/comparison-sets/archive` |
| 3380 | POST | `/profiles/create-with-birth` |
| 3432 | POST | `/saved-investigations/create` |
| 3463 | POST | `/saved-investigations/rename` |
| 3491 | POST | `/saved-investigations/archive` |
| 3527 | POST | `/profiles/rename` |
| 3554 | POST | `/profiles/archive` |
| 3588 | POST | `/places/resolve-or-create` |
...
$ python3 classify_write_routes.py  # inline one-off on 2026-06-17
TOTAL 57
LIVE 31  {'POST': 27, 'DELETE': 2, 'PUT': 1, 'PATCH': 1}
410-DEPRECATED 26  {'POST': 18, 'PATCH': 7, 'DELETE': 1}
```
